...
import com.github.wangyuheng.keeper.core.client.DingdingClient
import com.github.wangyuheng.keeper.core.client.GitlabClient
import com.github.wangyuheng.keeper.obelisk.GitlabHookBodyHelper.Companion.getChangedAssignee
...
class IssueListener {
    ...
    private fun handlerIssue(body: JSONObject) {
        ...
        if (changedAssignee != null) {
            val developer = userService.findByUsername(changedAssignee.username!!)
            ...
            if (GitlabHookBodyHelper.isFirstChangeToVerifyLabel(body)) {
                ...
                val mobile = userService.findByUsername(assigneeUsername)?.mobile
                if (null != mobile) {
