...
class OauthConfig : WebMvcConfigurer {
    ...
    override fun addInterceptors(registry: InterceptorRegistry) {
        registry.addInterceptor(OauthInterceptor(serverUrl, oauthProp, sessionManager))
...
class OauthInterceptor(var serverUrl: String, var oauthProp: OauthProp, var sessionManager: SessionManager) : HandlerInterceptor {
    ...
    override fun preHandle(request: HttpServletRequest, response: HttpServletResponse, handler: Any): Boolean {
        ...
        val gitlabAuthUrl: String = "$serverUrl/oauth/authorize?response_type=code&redirect_uri=$redirectUri&client_id=${oauthProp.clientId}"
